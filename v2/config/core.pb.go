...
var file_core_proto_goTypes = []interface{}{
	(*ParseConfigRequest)(nil),     // 0: SdmOptions.ParseConfigRequest
	(*ParseConfigResponse)(nil),    // 1: SdmOptions.ParseConfigResponse
	(*GenerateConfigRequest)(nil),  // 2: SdmOptions.GenerateConfigRequest
	(*GenerateConfigResponse)(nil), // 3: SdmOptions.GenerateConfigResponse
}
var file_core_proto_depIdxs = []int32{
	0, // 0: SdmOptions.CoreService.ParseConfig:input_type -> SdmOptions.ParseConfigRequest
	2, // 1: SdmOptions.CoreService.GenerateFullConfig:input_type -> SdmOptions.GenerateConfigRequest
	1, // 2: SdmOptions.CoreService.ParseConfig:output_type -> SdmOptions.ParseConfigResponse
	3, // 3: SdmOptions.CoreService.GenerateFullConfig:output_type -> SdmOptions.GenerateConfigResponse
