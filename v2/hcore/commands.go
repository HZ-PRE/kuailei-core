...
func (h *SdmInstance) readStatus(prev *SystemInfo) *SystemInfo {
...
func (h *SdmInstance) MakeSureContextIsNew(streamContext context.Context) {
	for range 10 {
...
func (h *SdmInstance) GetSystemInfo(stream grpc.ServerStreamingServer[SystemInfo]) error {
...
func (h *SdmInstance) SelectOutbound(in *SelectOutboundRequest) (*hcommon.Response, error) {
...
func (h *SdmInstance) UrlTestActive() (*hcommon.Response, error) {
	if box := h.Box(); box != nil {
...
func (h *SdmInstance) UrlTest(in *UrlTestRequest) (*hcommon.Response, error) {
	if in.Tag == "" {
