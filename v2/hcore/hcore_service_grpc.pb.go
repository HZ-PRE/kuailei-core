...
const (
	...
	Core_ChangeSdmSettings_FullMethodName     = "/hcore.Core/ChangeSdmSettings"
...
type CoreClient interface {
	...
	ChangeSdmSettings(ctx context.Context, in *ChangeSdmSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error)
...
func (c *coreClient) ChangeSdmSettings(ctx context.Context, in *ChangeSdmSettingsRequest, opts ...grpc.CallOption) (*CoreInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoreInfoResponse)
	err := c.cc.Invoke(ctx, Core_ChangeSdmSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	ChangeSdmSettings(context.Context, *ChangeSdmSettingsRequest) (*CoreInfoResponse, error)
	// rpc GenerateConfig (GenerateConfigRequest) returns (GenerateConfigResponse);
...
func (UnimplementedCoreServer) ChangeSdmSettings(context.Context, *ChangeSdmSettingsRequest) (*CoreInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeSdmSettings not implemented")
}
...
func _Core_ChangeSdmSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeSdmSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).ChangeSdmSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_ChangeSdmSettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).ChangeSdmSettings(ctx, req.(*ChangeSdmSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeSdmSettings",
			Handler:    _Core_ChangeSdmSettings_Handler,
		},
		{
