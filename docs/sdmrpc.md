...
- [v2/hcore/hcore.proto](#v2_hcore_hcore-proto)
    - [ChangeSdmSettingsRequest](#hcore-ChangeSdmSettingsRequest)
...
- [v2/sdmoptions/sdm_options.proto](#v2_sdmoptions_sdm_options-proto)
    - [DNSOptions](#sdmoptions-DNSOptions)
    - [SdmOptions](#sdmoptions-SdmOptions)
    - [InboundOptions](#sdmoptions-InboundOptions)
    - [IntRange](#sdmoptions-IntRange)
    - [MuxOptions](#sdmoptions-MuxOptions)
    - [RouteOptions](#sdmoptions-RouteOptions)
    - [Rule](#sdmoptions-Rule)
    - [TLSTricks](#sdmoptions-TLSTricks)
    - [URLTestOptions](#sdmoptions-URLTestOptions)
    - [WarpAccount](#sdmoptions-WarpAccount)
    - [WarpOptions](#sdmoptions-WarpOptions)
    - [WarpWireguardConfig](#sdmoptions-WarpWireguardConfig)
  
    - [DomainStrategy](#sdmoptions-DomainStrategy)
...
<a name="hcore-ChangeSdmSettingsRequest"></a>

### ChangeSdmSettingsRequest



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| sdm_settings_json | [string](#string) |  |  |
...
| ChangeSdmSettings | [ChangeSdmSettingsRequest](#hcore-ChangeSdmSettingsRequest) | [CoreInfoResponse](#hcore-CoreInfoResponse) |  |
...
<a name="v2_sdmoptions_sdm_options-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## v2/sdmoptions/sdm_options.proto



<a name="sdmoptions-DNSOptions"></a>
...
| remote_dns_domain_strategy | [DomainStrategy](#sdmoptions-DomainStrategy) |  | Strategy for resolving domains with remote DNS. |
| direct_dns_address | [string](#string) |  | Direct DNS server address. |
| direct_dns_domain_strategy | [DomainStrategy](#sdmoptions-DomainStrategy) |  | Strategy for resolving domains with direct DNS. |
...
<a name="sdmoptions-SdmOptions"></a>

### SdmOptions
SdmOptions defines the configuration options for the Sdm application.
...
| rules | [Rule](#sdmoptions-Rule) | repeated | List of routing rules for traffic management. |
| warp | [WarpOptions](#sdmoptions-WarpOptions) |  | Configuration options for Warp. |
| warp2 | [WarpOptions](#sdmoptions-WarpOptions) |  | Additional configuration options for a second Warp instance. |
| mux | [MuxOptions](#sdmoptions-MuxOptions) |  | Configuration options for multiplexing. |
| tls_tricks | [TLSTricks](#sdmoptions-TLSTricks) |  | Options for TLS tricks. |
| dns_options | [DNSOptions](#sdmoptions-DNSOptions) |  | DNS-related options. |
| inbound_options | [InboundOptions](#sdmoptions-InboundOptions) |  | Inbound connection options. |
| url_test_options | [URLTestOptions](#sdmoptions-URLTestOptions) |  | URL test configuration options. |
| route_options | [RouteOptions](#sdmoptions-RouteOptions) |  | Routing-related options. |
...
<a name="sdmoptions-InboundOptions"></a>
...
<a name="sdmoptions-MuxOptions"></a>
...
<a name="sdmoptions-RouteOptions"></a>
...
| ipv6_mode | [DomainStrategy](#sdmoptions-DomainStrategy) |  | Strategy for handling IPv6 addresses. |
...
| fragment_size | [IntRange](#sdmoptions-IntRange) |  | Size of fragments to be used. |
| fragment_sleep | [IntRange](#sdmoptions-IntRange) |  | Sleep time between fragments. |
...
| padding_size | [IntRange](#sdmoptions-IntRange) |  | Size of padding to be used. |
...
<a name="sdmoptions-URLTestOptions"></a>
...
<a name="sdmoptions-WarpAccount"></a>
...
<a name="sdmoptions-WarpOptions"></a>
...
| wireguard_config | [WarpWireguardConfig](#sdmoptions-WarpWireguardConfig) |  | Configuration for WireGuard (defined elsewhere). |
| fake_packets | [string](#string) |  | Fake packet configuration. |
| fake_packet_size | [IntRange](#sdmoptions-IntRange) |  | Size of fake packets. |
| fake_packet_delay | [IntRange](#sdmoptions-IntRange) |  | Delay for sending fake packets. |
...
| account | [WarpAccount](#sdmoptions-WarpAccount) |  | Account details for Warp (defined elsewhere). |
...
<a name="sdmoptions-WarpWireguardConfig"></a>
...
<a name="sdmoptions-DomainStrategy"></a>
...
| override_sdm_options | [sdmoptions.SdmOptions](#sdmoptions-SdmOptions) |  | Override Sdm options. |
