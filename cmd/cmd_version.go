...
import (
	...
	HC "github.com/HZ-PRE/kuailei-core/v2/hcommon/constants"
...
var commandVersion = &cobra.Command{
	Use:   "version",
	Short: "Print current version of sdm-core",
	Run:   printVersion,
	Args:  cobra.NoArgs,
}
...
func printVersion(cmd *cobra.Command, args []string) {
	...
	version := "sdm-core version " + HC.Version + " sdm-sing-box version " + C.Version + "\n\n"
