...
import (
	...
	"github.com/HZ-PRE/kuailei-core/config"
	pb "github.com/HZ-PRE/kuailei-core/hiddifyrpc"
	v2 "github.com/HZ-PRE/kuailei-core/v2"
...
func addHConfigFlags(commandRun *cobra.Command) {
	...
	commandRun.Flags().StringVarP(&hiddifySettingPath, "Kuailei", "d", "", "Kuailei Setting JSON Path")
	...
	commandRun.Flags().StringVar(&defaultConfigs.RemoteDnsAddress, "dns-remote", "8.8.8.8", "RemoteDNS (8.8.8.8, https://8.8.8.8/dns-query)")
	commandRun.Flags().StringVar(&defaultConfigs.DirectDnsAddress, "dns-direct", "8.8.8.8", "DirectDNS (8.8.8.8, https://8.8.8.8/dns-query)")
