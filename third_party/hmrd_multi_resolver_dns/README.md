...
designed to be embedded in [sdm-sing-box][singbox] (and through it,
[sdm-core][core]) as a more capable replacement for the current
single-upstream code path.

[singbox]: https://github.com/sdm/sdm-sing-box
[core]: https://github.com/sdm/sdm-core
...
- Every transport accepts a custom `DialFunc`, so an embedder (e.g.
  sdm-sing-box) can route DNS through a tunnel.
...
```bash
go get github.com/sdm/hmrd_multi_resolver_dns
```
...
This is the integration point for sdm-sing-box. Each resolver can
